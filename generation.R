...
bootstrap_sample_test_value <- function(n, X, C, theta_hat, lambda_hat){
  ...
  sort_Y_bstr_v_dt <- sort_Y_vals(Y_bstr_v_dt)

  list("S_n_1_1" =  S_n_1(a = 1, n, Y_bstr_v_dt),
       "S_n_1_2" =  S_n_1(a = 2, n, Y_bstr_v_dt),
       "S_n_1_5" =  S_n_1(a = 5, n, Y_bstr_v_dt),
       "S_n_2_1" =  S_n_2(a = 1, n, Y_bstr_v_dt),
       "S_n_2_2" =  S_n_2(a = 2, n, Y_bstr_v_dt),
       "S_n_2_5" =  S_n_2(a = 5, n, Y_bstr_v_dt),
...
list_of_test_vals_uncens <- foreach(i = 1:m, .packages = c("foreach", "data.table")) %dopar%{
...
getStatisticTestsValue <- function(i, strColName){
  unlist(lapply(list_of_test_vals_uncens, function(dt) dt[i, get(strColName)]))
}
...
Quantiles_DF <- getDataFrameQuantiles(m = 40)
